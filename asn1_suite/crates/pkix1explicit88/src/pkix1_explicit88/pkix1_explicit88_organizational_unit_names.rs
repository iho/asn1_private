...
#[derive(Debug, Clone)]
pub struct PKIX1Explicit88OrganizationalUnitNames(pub Vec<PKIX1Explicit88OrganizationalUnitName>);

impl Deref for PKIX1Explicit88OrganizationalUnitNames {
    type Target = Vec<PKIX1Explicit88OrganizationalUnitName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Explicit88OrganizationalUnitNames {
...
impl DERSerializable for PKIX1Explicit88OrganizationalUnitNames {
