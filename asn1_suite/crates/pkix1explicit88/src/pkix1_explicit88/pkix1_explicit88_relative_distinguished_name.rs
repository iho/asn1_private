...
#[derive(Debug, Clone)]
pub struct PKIX1Explicit88RelativeDistinguishedName(pub Vec<PKIX1Explicit88AttributeTypeAndValue>);

impl Deref for PKIX1Explicit88RelativeDistinguishedName {
    type Target = Vec<PKIX1Explicit88AttributeTypeAndValue>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Explicit88RelativeDistinguishedName {
...
impl DERSerializable for PKIX1Explicit88RelativeDistinguishedName {
