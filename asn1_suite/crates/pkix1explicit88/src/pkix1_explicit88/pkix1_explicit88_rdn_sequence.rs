...
#[derive(Debug, Clone)]
pub struct PKIX1Explicit88RDNSequence(pub Vec<PKIX1Explicit88RelativeDistinguishedName>);

impl Deref for PKIX1Explicit88RDNSequence {
    type Target = Vec<PKIX1Explicit88RelativeDistinguishedName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Explicit88RDNSequence {
...
impl DERSerializable for PKIX1Explicit88RDNSequence {
