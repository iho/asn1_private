...
#[derive(Clone, Debug)]
pub struct PKIXCommonTypes2009MATCHINGRULE {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for PKIXCommonTypes2009MATCHINGRULE {
...
impl DERSerializable for PKIXCommonTypes2009MATCHINGRULE {
