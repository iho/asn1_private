...
#[derive(Clone, Debug)]
pub enum RasterGrCodingAttributesCompression {
    Uncompressed = 0,
    Compressed = 1,
}

impl DERParseable for RasterGrCodingAttributesCompression {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(RasterGrCodingAttributesCompression::Uncompressed),
            1 => Ok(RasterGrCodingAttributesCompression::Compressed),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for RasterGrCodingAttributesCompression: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for RasterGrCodingAttributesCompression {
