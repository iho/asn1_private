...
#[derive(Clone, Debug)]
pub enum DORDefinitionAlteredValue {
    ValueNotAltered = 1,
    ValueAltered = 2,
    Undefined = 3,
}

impl DERParseable for DORDefinitionAlteredValue {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(DORDefinitionAlteredValue::ValueNotAltered),
            2 => Ok(DORDefinitionAlteredValue::ValueAltered),
            3 => Ok(DORDefinitionAlteredValue::Undefined),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for DORDefinitionAlteredValue: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for DORDefinitionAlteredValue {
