...
impl DERParseable for OCSPResponseStatus {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            ...
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for OCSPResponseStatus: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for OCSPResponseStatus {
