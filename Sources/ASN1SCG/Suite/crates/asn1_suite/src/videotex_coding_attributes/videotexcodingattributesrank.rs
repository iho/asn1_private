...
#[derive(Clone, Debug)]
pub enum VideotexCodingAttributesRank {
    Undefined = 0,
    Rank1 = 1,
    Rank2 = 2,
    Rank3 = 3,
...
impl DERParseable for VideotexCodingAttributesRank {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(VideotexCodingAttributesRank::Undefined),
            1 => Ok(VideotexCodingAttributesRank::Rank1),
            2 => Ok(VideotexCodingAttributesRank::Rank2),
            3 => Ok(VideotexCodingAttributesRank::Rank3),
            4 => Ok(VideotexCodingAttributesRank::Rank4),
            5 => Ok(VideotexCodingAttributesRank::Rank5),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for VideotexCodingAttributesRank: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for VideotexCodingAttributesRank {
