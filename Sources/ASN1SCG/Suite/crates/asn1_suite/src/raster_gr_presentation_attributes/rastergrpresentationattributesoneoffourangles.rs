...
#[derive(Clone, Debug)]
pub enum RasterGrPresentationAttributesOneOfFourAngles {
    D0 = 0,
    D90 = 1,
    D180 = 2,
    D270 = 3,
...
impl DERParseable for RasterGrPresentationAttributesOneOfFourAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(RasterGrPresentationAttributesOneOfFourAngles::D0),
            1 => Ok(RasterGrPresentationAttributesOneOfFourAngles::D90),
            2 => Ok(RasterGrPresentationAttributesOneOfFourAngles::D180),
            3 => Ok(RasterGrPresentationAttributesOneOfFourAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for RasterGrPresentationAttributesOneOfFourAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for RasterGrPresentationAttributesOneOfFourAngles {
