...
#[derive(Clone, Debug)]
pub enum StyleDescriptorsContentType {
    FormattedRasterGraphics = 1,
}

impl DERParseable for StyleDescriptorsContentType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(StyleDescriptorsContentType::FormattedRasterGraphics),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for StyleDescriptorsContentType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for StyleDescriptorsContentType {
