...
#[derive(Clone, Debug)]
pub enum StyleDescriptorsFillOrder {
    Normal = 0,
    Reverse = 1,
}

impl DERParseable for StyleDescriptorsFillOrder {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(StyleDescriptorsFillOrder::Normal),
            1 => Ok(StyleDescriptorsFillOrder::Reverse),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for StyleDescriptorsFillOrder: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for StyleDescriptorsFillOrder {
