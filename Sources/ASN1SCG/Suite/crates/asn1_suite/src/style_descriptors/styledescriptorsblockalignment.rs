...
#[derive(Clone, Debug)]
pub enum StyleDescriptorsBlockAlignment {
    RightHand = 0,
    LeftHand = 1,
    Centred = 2,
    Null = 3,
...
impl DERParseable for StyleDescriptorsBlockAlignment {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(StyleDescriptorsBlockAlignment::RightHand),
            1 => Ok(StyleDescriptorsBlockAlignment::LeftHand),
            2 => Ok(StyleDescriptorsBlockAlignment::Centred),
            3 => Ok(StyleDescriptorsBlockAlignment::Null),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for StyleDescriptorsBlockAlignment: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for StyleDescriptorsBlockAlignment {
