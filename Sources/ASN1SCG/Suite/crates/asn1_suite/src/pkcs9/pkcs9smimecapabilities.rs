...
#[derive(Debug, Clone)]
pub struct PKCS9SMIMECapabilities(pub Vec<PKCS9SMIMECapability>);

impl Deref for PKCS9SMIMECapabilities {
    type Target = Vec<PKCS9SMIMECapability>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS9SMIMECapabilities {
...
impl DERSerializable for PKCS9SMIMECapabilities {
