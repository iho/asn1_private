...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETEscClassCode {
    NotApplicable = 0,
    Monospace = 1,
    Proportional = 2,
}

impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETEscClassCode {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ISOSTANDARD9541FONTATTRIBUTESETEscClassCode::NotApplicable),
            1 => Ok(ISOSTANDARD9541FONTATTRIBUTESETEscClassCode::Monospace),
            2 => Ok(ISOSTANDARD9541FONTATTRIBUTESETEscClassCode::Proportional),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETEscClassCode: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETEscClassCode {
