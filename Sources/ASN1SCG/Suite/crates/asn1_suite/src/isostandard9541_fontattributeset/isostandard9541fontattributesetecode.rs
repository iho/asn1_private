...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETECode {
    NotApplicable = 0,
    LetterSpace = 1,
    WordSpace = 2,
    NoAdjust = 3,
...
impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETECode {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ISOSTANDARD9541FONTATTRIBUTESETECode::NotApplicable),
            1 => Ok(ISOSTANDARD9541FONTATTRIBUTESETECode::LetterSpace),
            2 => Ok(ISOSTANDARD9541FONTATTRIBUTESETECode::WordSpace),
            3 => Ok(ISOSTANDARD9541FONTATTRIBUTESETECode::NoAdjust),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETECode: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETECode {
