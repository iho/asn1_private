...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETCardinal {
    First = 0,
    Last = 4294967295,
}

impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETCardinal {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ISOSTANDARD9541FONTATTRIBUTESETCardinal::First),
            4294967295 => Ok(ISOSTANDARD9541FONTATTRIBUTESETCardinal::Last),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETCardinal: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETCardinal {
