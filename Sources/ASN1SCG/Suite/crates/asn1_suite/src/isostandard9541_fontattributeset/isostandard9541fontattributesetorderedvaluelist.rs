...
#[derive(Debug, Clone)]
pub struct ISOSTANDARD9541FONTATTRIBUTESETOrderedValueList(pub Vec<ISOSTANDARD9541FONTATTRIBUTESETValue>);

impl Deref for ISOSTANDARD9541FONTATTRIBUTESETOrderedValueList {
    type Target = Vec<ISOSTANDARD9541FONTATTRIBUTESETValue>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETOrderedValueList {
...
impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETOrderedValueList {
