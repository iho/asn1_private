...
#[derive(Clone, Debug)]
pub enum LayoutDescriptorsOneOfFourAngles {
    D0 = 0,
    D90 = 1,
    D180 = 2,
    D270 = 3,
...
impl DERParseable for LayoutDescriptorsOneOfFourAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LayoutDescriptorsOneOfFourAngles::D0),
            1 => Ok(LayoutDescriptorsOneOfFourAngles::D90),
            2 => Ok(LayoutDescriptorsOneOfFourAngles::D180),
            3 => Ok(LayoutDescriptorsOneOfFourAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LayoutDescriptorsOneOfFourAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LayoutDescriptorsOneOfFourAngles {
