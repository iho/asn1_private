...
#[derive(Clone, Debug)]
pub enum LayoutDescriptorsColour {
    ColourOfMedia = 0,
    Coloured = 1,
}

impl DERParseable for LayoutDescriptorsColour {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LayoutDescriptorsColour::ColourOfMedia),
            1 => Ok(LayoutDescriptorsColour::Coloured),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LayoutDescriptorsColour: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LayoutDescriptorsColour {
