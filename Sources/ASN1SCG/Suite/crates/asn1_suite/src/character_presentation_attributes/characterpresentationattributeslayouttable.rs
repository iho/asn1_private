...
#[derive(Debug, Clone)]
pub struct CharacterPresentationAttributesLayoutTable(pub Vec<CharacterPresentationAttributesTabulationStop>);

impl Deref for CharacterPresentationAttributesLayoutTable {
    type Target = Vec<CharacterPresentationAttributesTabulationStop>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CharacterPresentationAttributesLayoutTable {
...
impl DERSerializable for CharacterPresentationAttributesLayoutTable {
