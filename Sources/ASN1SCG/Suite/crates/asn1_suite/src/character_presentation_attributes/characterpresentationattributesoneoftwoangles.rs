...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesOneOfTwoAngles {
    D90 = 1,
    D270 = 3,
}

impl DERParseable for CharacterPresentationAttributesOneOfTwoAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(CharacterPresentationAttributesOneOfTwoAngles::D90),
            3 => Ok(CharacterPresentationAttributesOneOfTwoAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesOneOfTwoAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesOneOfTwoAngles {
