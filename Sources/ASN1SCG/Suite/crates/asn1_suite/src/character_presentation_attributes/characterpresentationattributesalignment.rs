...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesAlignment {
    StartAligned = 0,
    EndAligned = 1,
    Centred = 2,
    Justified = 3,
...
impl DERParseable for CharacterPresentationAttributesAlignment {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CharacterPresentationAttributesAlignment::StartAligned),
            1 => Ok(CharacterPresentationAttributesAlignment::EndAligned),
            2 => Ok(CharacterPresentationAttributesAlignment::Centred),
            3 => Ok(CharacterPresentationAttributesAlignment::Justified),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesAlignment: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesAlignment {
