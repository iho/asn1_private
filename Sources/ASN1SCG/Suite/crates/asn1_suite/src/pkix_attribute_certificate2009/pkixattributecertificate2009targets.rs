...
#[derive(Debug, Clone)]
pub struct PKIXAttributeCertificate2009Targets(pub Vec<PKIXAttributeCertificate2009Target>);

impl Deref for PKIXAttributeCertificate2009Targets {
    type Target = Vec<PKIXAttributeCertificate2009Target>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXAttributeCertificate2009Targets {
...
impl DERSerializable for PKIXAttributeCertificate2009Targets {
