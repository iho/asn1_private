...
#[derive(Debug, Clone)]
pub struct PKIXAttributeCertificate2009AttrSpec(pub Vec<ASN1ObjectIdentifier>);

impl Deref for PKIXAttributeCertificate2009AttrSpec {
    type Target = Vec<ASN1ObjectIdentifier>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXAttributeCertificate2009AttrSpec {
...
impl DERSerializable for PKIXAttributeCertificate2009AttrSpec {
