...
#[derive(Debug, Clone)]
pub struct PKIXAttributeCertificate2009ProxyInfo(pub Vec<PKIXAttributeCertificate2009Targets>);

impl Deref for PKIXAttributeCertificate2009ProxyInfo {
    type Target = Vec<PKIXAttributeCertificate2009Targets>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIXAttributeCertificate2009ProxyInfo {
...
impl DERSerializable for PKIXAttributeCertificate2009ProxyInfo {
