...
#[derive(Clone, Debug)]
pub enum PKIX1Explicit88Name {
    RdnSequence(crate::PKIX1Explicit88RDNSequence),
}

impl DERParseable for PKIX1Explicit88Name {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        match (node.identifier.tag_number, node.identifier.tag_class) {
            (219, TagClass::ContextSpecific) => Ok(Self::RdnSequence(crate::PKIX1Explicit88RDNSequence::from_der_node(node)?)),
            _ => Err(ASN1Error::new(
...
impl DERSerializable for PKIX1Explicit88Name {
