...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2009AuthAttributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2009AuthAttributes {
...
impl DERParseable for CryptographicMessageSyntax2009AuthAttributes {
...
impl DERSerializable for CryptographicMessageSyntax2009AuthAttributes {
