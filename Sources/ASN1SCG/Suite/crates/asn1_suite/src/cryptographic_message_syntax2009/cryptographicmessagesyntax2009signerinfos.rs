...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2009SignerInfos(pub Vec<CryptographicMessageSyntax2009SignerInfo>);

impl Deref for CryptographicMessageSyntax2009SignerInfos {
    type Target = Vec<CryptographicMessageSyntax2009SignerInfo>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CryptographicMessageSyntax2009SignerInfos {
...
impl DERSerializable for CryptographicMessageSyntax2009SignerInfos {
