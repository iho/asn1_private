...
#[derive(Debug, Clone)]
pub struct AlgorithmInformation2009SMIMECapabilities(pub Vec<AlgorithmInformation2009SMIMECapability>);

impl Deref for AlgorithmInformation2009SMIMECapabilities {
    type Target = Vec<AlgorithmInformation2009SMIMECapability>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for AlgorithmInformation2009SMIMECapabilities {
...
impl DERSerializable for AlgorithmInformation2009SMIMECapabilities {
