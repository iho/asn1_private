...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009MACALGORITHM {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009MACALGORITHM {
...
impl DERSerializable for AlgorithmInformation2009MACALGORITHM {
