...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009KEYTRANSPORT {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009KEYTRANSPORT {
...
impl DERSerializable for AlgorithmInformation2009KEYTRANSPORT {
