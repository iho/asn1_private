...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009SIGNATUREALGORITHM {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009SIGNATUREALGORITHM {
...
impl DERSerializable for AlgorithmInformation2009SIGNATUREALGORITHM {
