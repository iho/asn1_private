...
#[derive(Clone, Debug)]
pub enum AlgorithmInformation2009ParamOptions {
    Required = 0,
    PreferredPresent = 1,
    PreferredAbsent = 2,
    Absent = 3,
...
impl DERParseable for AlgorithmInformation2009ParamOptions {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(AlgorithmInformation2009ParamOptions::Required),
            1 => Ok(AlgorithmInformation2009ParamOptions::PreferredPresent),
            2 => Ok(AlgorithmInformation2009ParamOptions::PreferredAbsent),
            3 => Ok(AlgorithmInformation2009ParamOptions::Absent),
            4 => Ok(AlgorithmInformation2009ParamOptions::Inheritable),
            5 => Ok(AlgorithmInformation2009ParamOptions::Optional),

            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for AlgorithmInformation2009ParamOptions: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for AlgorithmInformation2009ParamOptions {
