...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009PUBLICKEY {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009PUBLICKEY {
...
impl DERSerializable for AlgorithmInformation2009PUBLICKEY {
