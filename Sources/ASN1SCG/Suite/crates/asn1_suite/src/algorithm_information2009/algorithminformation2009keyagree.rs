...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009KEYAGREE {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009KEYAGREE {
...
impl DERSerializable for AlgorithmInformation2009KEYAGREE {
