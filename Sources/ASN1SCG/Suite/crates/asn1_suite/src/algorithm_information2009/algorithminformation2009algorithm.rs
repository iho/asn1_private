...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009Algorithm {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009Algorithm {
...
impl DERSerializable for AlgorithmInformation2009Algorithm {
