...
#[derive(Debug, Clone)]
pub struct PKCS12SafeContents(pub Vec<PKCS12SafeBag>);

impl Deref for PKCS12SafeContents {
    type Target = Vec<PKCS12SafeBag>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS12SafeContents {
...
impl DERSerializable for PKCS12SafeContents {
