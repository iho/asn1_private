...
#[derive(Clone, Debug)]
pub enum CryptographicMessageSyntax2010CMSVersion {
    V0 = 0,
    V1 = 1,
    V2 = 2,
    V3 = 3,
...
impl DERParseable for CryptographicMessageSyntax2010CMSVersion {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CryptographicMessageSyntax2010CMSVersion::V0),
            1 => Ok(CryptographicMessageSyntax2010CMSVersion::V1),
            2 => Ok(CryptographicMessageSyntax2010CMSVersion::V2),
            3 => Ok(CryptographicMessageSyntax2010CMSVersion::V3),
            4 => Ok(CryptographicMessageSyntax2010CMSVersion::V4),
            5 => Ok(CryptographicMessageSyntax2010CMSVersion::V5),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CryptographicMessageSyntax2010CMSVersion: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CryptographicMessageSyntax2010CMSVersion {
