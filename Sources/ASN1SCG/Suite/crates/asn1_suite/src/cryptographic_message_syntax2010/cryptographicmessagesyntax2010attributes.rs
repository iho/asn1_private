...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2010Attributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2010Attributes {
...
impl DERParseable for CryptographicMessageSyntax2010Attributes {
...
impl DERSerializable for CryptographicMessageSyntax2010Attributes {
