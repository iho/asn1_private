...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2010AuthAttributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2010AuthAttributes {
...
impl DERParseable for CryptographicMessageSyntax2010AuthAttributes {
...
impl DERSerializable for CryptographicMessageSyntax2010AuthAttributes {
