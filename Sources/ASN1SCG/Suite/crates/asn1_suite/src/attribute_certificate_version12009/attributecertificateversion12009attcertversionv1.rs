...
#[derive(Clone, Debug)]
pub enum AttributeCertificateVersion12009AttCertVersionV1 {
    V1 = 0,
}

impl DERParseable for AttributeCertificateVersion12009AttCertVersionV1 {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(AttributeCertificateVersion12009AttCertVersionV1::V1),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for AttributeCertificateVersion12009AttCertVersionV1: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for AttributeCertificateVersion12009AttCertVersionV1 {
