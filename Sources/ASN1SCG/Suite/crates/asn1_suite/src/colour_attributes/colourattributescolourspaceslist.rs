...
#[derive(Debug, Clone)]
pub struct ColourAttributesColourSpacesList(pub Vec<ColourAttributesColourSpace>);

impl Deref for ColourAttributesColourSpacesList {
    type Target = Vec<ColourAttributesColourSpace>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ColourAttributesColourSpacesList {
...
impl DERSerializable for ColourAttributesColourSpacesList {
