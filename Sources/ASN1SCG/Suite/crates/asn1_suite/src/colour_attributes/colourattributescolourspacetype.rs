...
#[derive(Clone, Debug)]
pub enum ColourAttributesColourSpaceType {
    Rgb = 0,
    Cmyk = 1,
    Cmy = 2,
    Cieluv = 3,
...
impl DERParseable for ColourAttributesColourSpaceType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ColourAttributesColourSpaceType::Rgb),
            1 => Ok(ColourAttributesColourSpaceType::Cmyk),
            2 => Ok(ColourAttributesColourSpaceType::Cmy),
            3 => Ok(ColourAttributesColourSpaceType::Cieluv),
            4 => Ok(ColourAttributesColourSpaceType::Cielab),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ColourAttributesColourSpaceType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ColourAttributesColourSpaceType {
