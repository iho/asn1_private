...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesTextRenditionTextPrecisionEnum {
    String = 0,
    Character = 1,
    Stroke = 2,
}

impl DERParseable for GeoGrPresentationAttributesTextRenditionTextPrecisionEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesTextRenditionTextPrecisionEnum::String),
            1 => Ok(GeoGrPresentationAttributesTextRenditionTextPrecisionEnum::Character),
            2 => Ok(GeoGrPresentationAttributesTextRenditionTextPrecisionEnum::Stroke),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesTextRenditionTextPrecisionEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesTextRenditionTextPrecisionEnum {
