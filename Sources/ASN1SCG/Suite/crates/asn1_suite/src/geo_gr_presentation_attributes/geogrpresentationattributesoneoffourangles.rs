...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesOneOfFourAngles {
    D0 = 0,
    D90 = 1,
    D180 = 2,
    D270 = 3,
...
impl DERParseable for GeoGrPresentationAttributesOneOfFourAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesOneOfFourAngles::D0),
            1 => Ok(GeoGrPresentationAttributesOneOfFourAngles::D90),
            2 => Ok(GeoGrPresentationAttributesOneOfFourAngles::D180),
            3 => Ok(GeoGrPresentationAttributesOneOfFourAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesOneOfFourAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesOneOfFourAngles {
