...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum {
    NormalHorizontal = 0,
    Left = 1,
    Centre = 2,
    Right = 3,
...
impl DERParseable for GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum::NormalHorizontal),
            1 => Ok(GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum::Left),
            2 => Ok(GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum::Centre),
            3 => Ok(GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum::Right),
            4 => Ok(GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum::ContinuousHorizontal),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesTextRenditionTextAlignmentSequenceHorizontalAlignmentEnum {
