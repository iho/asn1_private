...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum {
    Basic7Bit = 0,
    Basic8Bit = 1,
    Extended7Bit = 2,
    Extended8Bit = 3,
...
impl DERParseable for GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum::Basic7Bit),
            1 => Ok(GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum::Basic8Bit),
            2 => Ok(GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum::Extended7Bit),
            3 => Ok(GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum::Extended8Bit),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesTextRenditionCharacterCodingAnnouncerEnum {
