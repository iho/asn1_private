...
#[derive(Debug, Clone)]
pub struct PKIX1Implicit88GeneralNames(pub Vec<PKIX1Implicit88GeneralName>);

impl Deref for PKIX1Implicit88GeneralNames {
    type Target = Vec<PKIX1Implicit88GeneralName>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Implicit88GeneralNames {
...
impl DERSerializable for PKIX1Implicit88GeneralNames {
