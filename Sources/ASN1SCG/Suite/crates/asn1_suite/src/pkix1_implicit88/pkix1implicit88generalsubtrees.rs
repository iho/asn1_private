...
#[derive(Debug, Clone)]
pub struct PKIX1Implicit88GeneralSubtrees(pub Vec<PKIX1Implicit88GeneralSubtree>);

impl Deref for PKIX1Implicit88GeneralSubtrees {
    type Target = Vec<PKIX1Implicit88GeneralSubtree>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Implicit88GeneralSubtrees {
...
impl DERSerializable for PKIX1Implicit88GeneralSubtrees {
