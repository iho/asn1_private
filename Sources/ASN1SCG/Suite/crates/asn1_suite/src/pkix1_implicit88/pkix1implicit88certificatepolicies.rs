...
#[derive(Debug, Clone)]
pub struct PKIX1Implicit88CertificatePolicies(pub Vec<PKIX1Implicit88PolicyInformation>);

impl Deref for PKIX1Implicit88CertificatePolicies {
    type Target = Vec<PKIX1Implicit88PolicyInformation>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Implicit88CertificatePolicies {
...
impl DERSerializable for PKIX1Implicit88CertificatePolicies {
