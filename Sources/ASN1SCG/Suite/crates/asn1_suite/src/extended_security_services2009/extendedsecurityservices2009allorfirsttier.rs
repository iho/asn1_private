...
#[derive(Clone, Debug)]
pub enum ExtendedSecurityServices2009AllOrFirstTier {
    AllReceipts = 0,
    FirstTierRecipients = 1,
}

impl DERParseable for ExtendedSecurityServices2009AllOrFirstTier {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ExtendedSecurityServices2009AllOrFirstTier::AllReceipts),
            1 => Ok(ExtendedSecurityServices2009AllOrFirstTier::FirstTierRecipients),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ExtendedSecurityServices2009AllOrFirstTier: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ExtendedSecurityServices2009AllOrFirstTier {
