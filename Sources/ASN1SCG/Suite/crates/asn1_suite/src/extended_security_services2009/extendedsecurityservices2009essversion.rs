...
#[derive(Clone, Debug)]
pub enum ExtendedSecurityServices2009ESSVersion {
    V1 = 1,
}

impl DERParseable for ExtendedSecurityServices2009ESSVersion {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(ExtendedSecurityServices2009ESSVersion::V1),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ExtendedSecurityServices2009ESSVersion: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ExtendedSecurityServices2009ESSVersion {
