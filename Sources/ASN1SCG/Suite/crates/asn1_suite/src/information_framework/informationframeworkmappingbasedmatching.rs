...
#[derive(Clone, Debug)]
pub struct InformationFrameworkMAPPINGBASEDMATCHING {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for InformationFrameworkMAPPINGBASEDMATCHING {
...
impl DERSerializable for InformationFrameworkMAPPINGBASEDMATCHING {
