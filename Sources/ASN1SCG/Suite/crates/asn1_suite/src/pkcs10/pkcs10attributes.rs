...
#[derive(Debug, Clone)]
pub struct PKCS10Attributes(pub Vec<PKCS10Attribute>);

impl Deref for PKCS10Attributes {
    type Target = Vec<PKCS10Attribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS10Attributes {
...
impl DERSerializable for PKCS10Attributes {
