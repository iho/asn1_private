...
#[derive(Debug, Clone)]
pub struct PKCS7ExtendedCertificatesAndCertificates(pub Vec<PKCS7ExtendedCertificateOrCertificate>);

impl Deref for PKCS7ExtendedCertificatesAndCertificates {
    type Target = Vec<PKCS7ExtendedCertificateOrCertificate>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS7ExtendedCertificatesAndCertificates {
...
impl DERSerializable for PKCS7ExtendedCertificatesAndCertificates {
