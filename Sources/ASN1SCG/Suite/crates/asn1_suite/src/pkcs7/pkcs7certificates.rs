...
#[derive(Debug, Clone)]
pub struct PKCS7Certificates(pub Vec<PKIX1Explicit2009Certificate>);

impl Deref for PKCS7Certificates {
    type Target = Vec<PKIX1Explicit2009Certificate>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS7Certificates {
...
impl DERSerializable for PKCS7Certificates {
