...
#[derive(Debug, Clone)]
pub struct PKCS7CRLSequence(pub Vec<PKIX1Explicit2009CertificateList>);

impl Deref for PKCS7CRLSequence {
...
impl DERParseable for PKCS7CRLSequence {
...
impl DERSerializable for PKCS7CRLSequence {
