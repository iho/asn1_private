...
#[derive(Debug, Clone)]
pub struct TextUnitsTiledContent(pub Vec<ASN1OctetString>);

impl Deref for TextUnitsTiledContent {
    type Target = Vec<ASN1OctetString>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for TextUnitsTiledContent {
...
impl DERSerializable for TextUnitsTiledContent {
