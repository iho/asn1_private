...
#[derive(Clone, Debug)]
pub enum SMIMESymmetricKeyDistribution2009GLAdministration {
    Unmanaged = 0,
    Managed = 1,
    Closed = 2,
}

impl DERParseable for SMIMESymmetricKeyDistribution2009GLAdministration {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(SMIMESymmetricKeyDistribution2009GLAdministration::Unmanaged),
            1 => Ok(SMIMESymmetricKeyDistribution2009GLAdministration::Managed),
            2 => Ok(SMIMESymmetricKeyDistribution2009GLAdministration::Closed),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for SMIMESymmetricKeyDistribution2009GLAdministration: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for SMIMESymmetricKeyDistribution2009GLAdministration {
