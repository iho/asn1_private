...
#[derive(Clone, Debug)]
pub enum LogicalDescriptorsLogicalObjectType {
    DocumentLogicalRoot = 0,
    CompositeLogicalObject = 1,
    BasicLogicalObject = 2,
}

impl DERParseable for LogicalDescriptorsLogicalObjectType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LogicalDescriptorsLogicalObjectType::DocumentLogicalRoot),
            1 => Ok(LogicalDescriptorsLogicalObjectType::CompositeLogicalObject),
            2 => Ok(LogicalDescriptorsLogicalObjectType::BasicLogicalObject),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LogicalDescriptorsLogicalObjectType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LogicalDescriptorsLogicalObjectType {
