...
#[derive(Clone, Debug)]
pub enum LogicalDescriptorsProtection {
    Unprotected = 0,
    Protected = 1,
}

impl DERParseable for LogicalDescriptorsProtection {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LogicalDescriptorsProtection::Unprotected),
            1 => Ok(LogicalDescriptorsProtection::Protected),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LogicalDescriptorsProtection: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LogicalDescriptorsProtection {
