...
#[derive(Clone, Debug)]
pub enum TemporalRelationshipsSynchronizationType {
    ParallelLast = 0,
    ParallelFirst = 1,
    ParallelSelective = 2,
    Sequential = 3,
...
impl DERParseable for TemporalRelationshipsSynchronizationType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(TemporalRelationshipsSynchronizationType::ParallelLast),
            1 => Ok(TemporalRelationshipsSynchronizationType::ParallelFirst),
            2 => Ok(TemporalRelationshipsSynchronizationType::ParallelSelective),
            3 => Ok(TemporalRelationshipsSynchronizationType::Sequential),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for TemporalRelationshipsSynchronizationType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for TemporalRelationshipsSynchronizationType {
