...
#[derive(Clone, Debug)]
pub enum TemporalRelationshipsTimeDelay {
    Indefinite = -1,
}

impl DERParseable for TemporalRelationshipsTimeDelay {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            -1 => Ok(TemporalRelationshipsTimeDelay::Indefinite),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for TemporalRelationshipsTimeDelay: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for TemporalRelationshipsTimeDelay {
