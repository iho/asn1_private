...
@usableFromInline struct LDAP_ExtendedRequest: DERImplicitlyTaggable, BERParseable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try BER.sequence(root, identifier: identifier) { nodes in
            let requestName: ASN1OctetString = (try BER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 0, tagClass: .contextSpecific)))!
            let requestValue: ASN1OctetString? = try BER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 1, tagClass: .contextSpecific))
