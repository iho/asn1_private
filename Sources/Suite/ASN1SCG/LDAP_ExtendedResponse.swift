...
@usableFromInline struct LDAP_ExtendedResponse: DERImplicitlyTaggable, BERParseable, Hashable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try BER.sequence(root, identifier: identifier) { nodes in
            ...
            let referral: LDAP_Referral? = try BER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 3, tagClass: .contextSpecific))
            let responseName: ASN1OctetString? = try BER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 10, tagClass: .contextSpecific))
            let responseValue: ASN1OctetString? = try BER.optionalImplicitlyTagged(&nodes, tag: ASN1Identifier(tagWithNumber: 11, tagClass: .contextSpecific))
