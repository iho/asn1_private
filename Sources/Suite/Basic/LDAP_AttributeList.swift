...
@usableFromInline struct LDAP_AttributeList: DERImplicitlyTaggable, DERParseable, DERSerializable, Hashable, Sendable {
    ...
    @usableFromInline var value: [InformationFramework_Attribute]
    @inlinable public init(_ value: [InformationFramework_Attribute]) { self.value = value }
    @inlinable public init(derEncoded rootNode: ASN1Node, withIdentifier identifier: ASN1Identifier) throws {
        self.value = try DER.sequence(of: InformationFramework_Attribute.self, identifier: identifier, rootNode: rootNode)
    }
