...
#[derive(Clone, Debug)]
pub enum StyleDescriptorsConcatenation {
    NonConcatenated = 0,
    Concatenated = 1,
}

impl DERParseable for StyleDescriptorsConcatenation {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(StyleDescriptorsConcatenation::NonConcatenated),
            1 => Ok(StyleDescriptorsConcatenation::Concatenated),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for StyleDescriptorsConcatenation: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for StyleDescriptorsConcatenation {
