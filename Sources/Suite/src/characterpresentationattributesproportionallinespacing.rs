...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesProportionalLineSpacing {
    No = 0,
    Yes = 1,
}

impl DERParseable for CharacterPresentationAttributesProportionalLineSpacing {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CharacterPresentationAttributesProportionalLineSpacing::No),
            1 => Ok(CharacterPresentationAttributesProportionalLineSpacing::Yes),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesProportionalLineSpacing: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesProportionalLineSpacing {
