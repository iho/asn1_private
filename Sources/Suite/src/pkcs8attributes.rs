...
#[derive(Debug, Clone)]
pub struct PKCS8Attributes(pub Vec<PKIX1Explicit88Attribute>);

impl Deref for PKCS8Attributes {
    type Target = Vec<PKIX1Explicit88Attribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKCS8Attributes {
...
impl DERSerializable for PKCS8Attributes {
