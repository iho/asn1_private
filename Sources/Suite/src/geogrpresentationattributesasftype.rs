...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesASFType {
    Bundled = 0,
    Individual = 1,
}

impl DERParseable for GeoGrPresentationAttributesASFType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesASFType::Bundled),
            1 => Ok(GeoGrPresentationAttributesASFType::Individual),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesASFType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesASFType {
