...
#[derive(Debug, Clone)]
pub struct DocumentProfileDescriptorFontsList(pub Vec<DocumentProfileDescriptorFontsListElement>);

impl Deref for DocumentProfileDescriptorFontsList {
    type Target = Vec<DocumentProfileDescriptorFontsListElement>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for DocumentProfileDescriptorFontsList {
...
impl DERSerializable for DocumentProfileDescriptorFontsList {
