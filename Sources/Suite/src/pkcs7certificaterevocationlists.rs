...
#[derive(Debug, Clone)]
pub struct PKCS7CertificateRevocationLists(pub Vec<PKIX1Explicit2009CertificateList>);

impl Deref for PKCS7CertificateRevocationLists {
...
impl DERParseable for PKCS7CertificateRevocationLists {
...
impl DERSerializable for PKCS7CertificateRevocationLists {
