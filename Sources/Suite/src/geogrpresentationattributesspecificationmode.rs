...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesSpecificationMode {
    Absolute = 0,
    Scaled = 1,
}

impl DERParseable for GeoGrPresentationAttributesSpecificationMode {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesSpecificationMode::Absolute),
            1 => Ok(GeoGrPresentationAttributesSpecificationMode::Scaled),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesSpecificationMode: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesSpecificationMode {
