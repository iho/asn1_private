...
#[derive(Debug, Clone)]
pub struct PKIX1Explicit88Extensions(pub Vec<PKIX1Explicit88Extension>);

impl Deref for PKIX1Explicit88Extensions {
    type Target = Vec<PKIX1Explicit88Extension>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Explicit88Extensions {
...
impl DERSerializable for PKIX1Explicit88Extensions {
