...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesOnOrOff {
    Off = 0,
    On = 1,
}

impl DERParseable for GeoGrPresentationAttributesOnOrOff {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesOnOrOff::Off),
            1 => Ok(GeoGrPresentationAttributesOnOrOff::On),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesOnOrOff: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesOnOrOff {
