...
#[derive(Debug, Clone)]
pub struct ExternalReferencesList(pub Vec<ExternalReferencesListElement>);

impl Deref for ExternalReferencesList {
    type Target = Vec<ExternalReferencesListElement>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ExternalReferencesList {
...
impl DERSerializable for ExternalReferencesList {
