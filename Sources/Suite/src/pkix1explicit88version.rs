...
#[derive(Clone, Debug)]
pub enum PKIX1Explicit88Version {
    V1 = 0,
    V2 = 1,
    V3 = 2,
}

impl DERParseable for PKIX1Explicit88Version {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(PKIX1Explicit88Version::V1),
            1 => Ok(PKIX1Explicit88Version::V2),
            2 => Ok(PKIX1Explicit88Version::V3),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKIX1Explicit88Version: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKIX1Explicit88Version {
