...
#[derive(Clone, Debug)]
pub enum PKIXAttributeCertificate2009AttCertVersion {
    V2 = 1,
}

impl DERParseable for PKIXAttributeCertificate2009AttCertVersion {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(PKIXAttributeCertificate2009AttCertVersion::V2),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKIXAttributeCertificate2009AttCertVersion: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKIXAttributeCertificate2009AttCertVersion {
