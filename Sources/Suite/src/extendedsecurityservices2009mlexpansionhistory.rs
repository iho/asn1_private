...
#[derive(Debug, Clone)]
pub struct ExtendedSecurityServices2009MLExpansionHistory(pub Vec<ExtendedSecurityServices2009MLData>);

impl Deref for ExtendedSecurityServices2009MLExpansionHistory {
    type Target = Vec<ExtendedSecurityServices2009MLData>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ExtendedSecurityServices2009MLExpansionHistory {
...
impl DERSerializable for ExtendedSecurityServices2009MLExpansionHistory {
