...
#[derive(Clone, Debug)]
pub enum PKIX1Implicit88CRLReason {
    Unspecified = 0,
    KeyCompromise = 1,
    CACompromise = 2,
...
impl DERParseable for PKIX1Implicit88CRLReason {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(PKIX1Implicit88CRLReason::Unspecified),
            1 => Ok(PKIX1Implicit88CRLReason::KeyCompromise),
            2 => Ok(PKIX1Implicit88CRLReason::CACompromise),
            3 => Ok(PKIX1Implicit88CRLReason::AffiliationChanged),
            4 => Ok(PKIX1Implicit88CRLReason::Superseded),
            5 => Ok(PKIX1Implicit88CRLReason::CessationOfOperation),
            6 => Ok(PKIX1Implicit88CRLReason::CertificateHold),
            8 => Ok(PKIX1Implicit88CRLReason::RemoveFromCRL),
            9 => Ok(PKIX1Implicit88CRLReason::PrivilegeWithdrawn),
            10 => Ok(PKIX1Implicit88CRLReason::AACompromise),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKIX1Implicit88CRLReason: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKIX1Implicit88CRLReason {
