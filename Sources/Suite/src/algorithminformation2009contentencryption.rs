...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009CONTENTENCRYPTION {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009CONTENTENCRYPTION {
...
impl DERSerializable for AlgorithmInformation2009CONTENTENCRYPTION {
