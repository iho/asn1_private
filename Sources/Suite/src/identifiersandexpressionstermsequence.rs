...
#[derive(Debug, Clone)]
pub struct IdentifiersAndExpressionsTermSequence(pub Vec<IdentifiersAndExpressionsConstructionTerm>);

impl Deref for IdentifiersAndExpressionsTermSequence {
    type Target = Vec<IdentifiersAndExpressionsConstructionTerm>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for IdentifiersAndExpressionsTermSequence {
...
impl DERSerializable for IdentifiersAndExpressionsTermSequence {
