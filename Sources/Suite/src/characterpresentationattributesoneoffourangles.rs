...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesOneOfFourAngles {
    D0 = 0,
    D90 = 1,
    D180 = 2,
    D270 = 3,
...
impl DERParseable for CharacterPresentationAttributesOneOfFourAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CharacterPresentationAttributesOneOfFourAngles::D0),
            1 => Ok(CharacterPresentationAttributesOneOfFourAngles::D90),
            2 => Ok(CharacterPresentationAttributesOneOfFourAngles::D180),
            3 => Ok(CharacterPresentationAttributesOneOfFourAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesOneOfFourAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesOneOfFourAngles {
