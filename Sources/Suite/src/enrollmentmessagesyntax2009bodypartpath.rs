...
#[derive(Debug, Clone)]
pub struct EnrollmentMessageSyntax2009BodyPartPath(pub Vec<EnrollmentMessageSyntax2009BodyPartID>);

impl Deref for EnrollmentMessageSyntax2009BodyPartPath {
    type Target = Vec<EnrollmentMessageSyntax2009BodyPartID>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for EnrollmentMessageSyntax2009BodyPartPath {
...
impl DERSerializable for EnrollmentMessageSyntax2009BodyPartPath {
