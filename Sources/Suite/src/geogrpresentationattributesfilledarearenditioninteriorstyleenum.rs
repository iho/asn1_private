...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum {
    Hollow = 0,
    Solid = 1,
    Pattern = 2,
    Hatch = 3,
...
impl DERParseable for GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum::Hollow),
            1 => Ok(GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum::Solid),
            2 => Ok(GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum::Pattern),
            3 => Ok(GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum::Hatch),
            4 => Ok(GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum::Empty),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesFilledAreaRenditionInteriorStyleEnum {
