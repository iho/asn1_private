...
#[derive(Clone, Debug)]
pub enum PKIX1Explicit88TerminalType {
    Telex = 3,
    Teletex = 4,
    G3Facsimile = 5,
    G4Facsimile = 6,
...
impl DERParseable for PKIX1Explicit88TerminalType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            3 => Ok(PKIX1Explicit88TerminalType::Telex),
            4 => Ok(PKIX1Explicit88TerminalType::Teletex),
            5 => Ok(PKIX1Explicit88TerminalType::G3Facsimile),
            6 => Ok(PKIX1Explicit88TerminalType::G4Facsimile),
            7 => Ok(PKIX1Explicit88TerminalType::Ia5Terminal),
            8 => Ok(PKIX1Explicit88TerminalType::Videotex),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKIX1Explicit88TerminalType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKIX1Explicit88TerminalType {
