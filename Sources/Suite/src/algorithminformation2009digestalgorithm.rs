...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009DIGESTALGORITHM {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009DIGESTALGORITHM {
...
impl DERSerializable for AlgorithmInformation2009DIGESTALGORITHM {
