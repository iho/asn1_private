...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesFormattingIndicator {
    No = 0,
    Yes = 1,
}

impl DERParseable for CharacterPresentationAttributesFormattingIndicator {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CharacterPresentationAttributesFormattingIndicator::No),
            1 => Ok(CharacterPresentationAttributesFormattingIndicator::Yes),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesFormattingIndicator: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesFormattingIndicator {
