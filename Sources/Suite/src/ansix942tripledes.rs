...
#[derive(Debug, Clone)]
pub struct ANSIX942TripleDES(pub Vec<ASN1Integer>);

impl Deref for ANSIX942TripleDES {
...
impl DERParseable for ANSIX942TripleDES {
...
impl DERSerializable for ANSIX942TripleDES {
