...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2009RecipientInfos(pub Vec<CryptographicMessageSyntax2009RecipientInfo>);

impl Deref for CryptographicMessageSyntax2009RecipientInfos {
    type Target = Vec<CryptographicMessageSyntax2009RecipientInfo>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CryptographicMessageSyntax2009RecipientInfos {
...
impl DERSerializable for CryptographicMessageSyntax2009RecipientInfos {
