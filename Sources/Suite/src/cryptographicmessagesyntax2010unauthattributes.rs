...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2010UnauthAttributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2010UnauthAttributes {
    type Target = Vec<crate::PKIXCommonTypes2009Attribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CryptographicMessageSyntax2010UnauthAttributes {
...
impl DERSerializable for CryptographicMessageSyntax2010UnauthAttributes {
