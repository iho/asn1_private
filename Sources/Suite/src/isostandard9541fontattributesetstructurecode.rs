...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETStructureCode {
    NotApplicable = 0,
    Solid = 1,
    Outline = 2,
}

impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETStructureCode {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ISOSTANDARD9541FONTATTRIBUTESETStructureCode::NotApplicable),
            1 => Ok(ISOSTANDARD9541FONTATTRIBUTESETStructureCode::Solid),
            2 => Ok(ISOSTANDARD9541FONTATTRIBUTESETStructureCode::Outline),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETStructureCode: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETStructureCode {
