...
impl DERParseable for PKCS8Version {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(PKCS8Version::V1),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKCS8Version: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKCS8Version {
