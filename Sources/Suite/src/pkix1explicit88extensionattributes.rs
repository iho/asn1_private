...
#[derive(Debug, Clone)]
pub struct PKIX1Explicit88ExtensionAttributes(pub Vec<PKIX1Explicit88ExtensionAttribute>);

impl Deref for PKIX1Explicit88ExtensionAttributes {
    type Target = Vec<PKIX1Explicit88ExtensionAttribute>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Explicit88ExtensionAttributes {
...
impl DERSerializable for PKIX1Explicit88ExtensionAttributes {
