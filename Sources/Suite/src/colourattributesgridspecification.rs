...
#[derive(Debug, Clone)]
pub struct ColourAttributesGridSpecification(pub Vec<ColourAttributesGridSpecificationElement>);

impl Deref for ColourAttributesGridSpecification {
    type Target = Vec<ColourAttributesGridSpecificationElement>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ColourAttributesGridSpecification {
...
impl DERSerializable for ColourAttributesGridSpecification {
