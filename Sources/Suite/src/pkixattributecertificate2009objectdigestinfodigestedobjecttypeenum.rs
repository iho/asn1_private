...
#[derive(Clone, Debug)]
pub enum PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum {
    PublicKey = 0,
    PublicKeyCert = 1,
    OtherObjectTypes = 2,
}

impl DERParseable for PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum::PublicKey),
            1 => Ok(PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum::PublicKeyCert),
            2 => Ok(PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum::OtherObjectTypes),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for PKIXAttributeCertificate2009ObjectDigestInfoDigestedObjectTypeEnum {
