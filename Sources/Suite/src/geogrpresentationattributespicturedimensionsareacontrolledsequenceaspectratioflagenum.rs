...
#[derive(Clone, Debug)]
pub enum GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum {
    Fixed = 0,
    Variable = 1,
}

impl DERParseable for GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum::Fixed),
            1 => Ok(GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum::Variable),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for GeoGrPresentationAttributesPictureDimensionsAreaControlledSequenceAspectRatioFlagEnum {
