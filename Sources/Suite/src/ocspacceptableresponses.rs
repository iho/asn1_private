...
#[derive(Debug, Clone)]
pub struct OCSPAcceptableResponses(pub Vec<ASN1ObjectIdentifier>);

impl Deref for OCSPAcceptableResponses {
...
impl DERParseable for OCSPAcceptableResponses {
...
impl DERSerializable for OCSPAcceptableResponses {
