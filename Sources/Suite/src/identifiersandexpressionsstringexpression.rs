...
#[derive(Debug, Clone)]
pub struct IdentifiersAndExpressionsStringExpression(pub Vec<IdentifiersAndExpressionsAtomicStringExpression>);

impl Deref for IdentifiersAndExpressionsStringExpression {
    type Target = Vec<IdentifiersAndExpressionsAtomicStringExpression>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for IdentifiersAndExpressionsStringExpression {
...
impl DERSerializable for IdentifiersAndExpressionsStringExpression {
