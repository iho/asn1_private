...
#[derive(Clone, Debug)]
pub enum RasterGrPresentationAttributesOneOfTwoAngles {
    D90 = 1,
    D270 = 3,
}

impl DERParseable for RasterGrPresentationAttributesOneOfTwoAngles {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(RasterGrPresentationAttributesOneOfTwoAngles::D90),
            3 => Ok(RasterGrPresentationAttributesOneOfTwoAngles::D270),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for RasterGrPresentationAttributesOneOfTwoAngles: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for RasterGrPresentationAttributesOneOfTwoAngles {
