...
#[derive(Clone, Debug)]
pub enum ExtendedSecurityServices2009SecurityClassification {
    Unmarked = 0,
    Unclassified = 1,
    Restricted = 2,
    Confidential = 3,
...
impl DERParseable for ExtendedSecurityServices2009SecurityClassification {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ExtendedSecurityServices2009SecurityClassification::Unmarked),
            1 => Ok(ExtendedSecurityServices2009SecurityClassification::Unclassified),
            2 => Ok(ExtendedSecurityServices2009SecurityClassification::Restricted),
            3 => Ok(ExtendedSecurityServices2009SecurityClassification::Confidential),
            4 => Ok(ExtendedSecurityServices2009SecurityClassification::Secret),
            5 => Ok(ExtendedSecurityServices2009SecurityClassification::TopSecret),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ExtendedSecurityServices2009SecurityClassification: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ExtendedSecurityServices2009SecurityClassification {
