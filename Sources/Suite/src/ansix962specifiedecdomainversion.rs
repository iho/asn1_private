...
#[derive(Clone, Debug)]
pub enum ANSIX962SpecifiedECDomainVersion {
    EcdpVer1 = 1,
    EcdpVer2 = 2,
    EcdpVer3 = 3,
}

impl DERParseable for ANSIX962SpecifiedECDomainVersion {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            1 => Ok(ANSIX962SpecifiedECDomainVersion::EcdpVer1),
            2 => Ok(ANSIX962SpecifiedECDomainVersion::EcdpVer2),
            3 => Ok(ANSIX962SpecifiedECDomainVersion::EcdpVer3),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ANSIX962SpecifiedECDomainVersion: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ANSIX962SpecifiedECDomainVersion {
