...
#[derive(Debug, Clone)]
pub struct PKIX1Implicit88AuthorityInfoAccessSyntax(pub Vec<PKIX1Implicit88AccessDescription>);

impl Deref for PKIX1Implicit88AuthorityInfoAccessSyntax {
    type Target = Vec<PKIX1Implicit88AccessDescription>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for PKIX1Implicit88AuthorityInfoAccessSyntax {
...
impl DERSerializable for PKIX1Implicit88AuthorityInfoAccessSyntax {
