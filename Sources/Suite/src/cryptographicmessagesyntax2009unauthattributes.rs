...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2009UnauthAttributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2009UnauthAttributes {
...
impl DERParseable for CryptographicMessageSyntax2009UnauthAttributes {
...
impl DERSerializable for CryptographicMessageSyntax2009UnauthAttributes {
