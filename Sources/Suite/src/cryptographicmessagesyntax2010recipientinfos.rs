...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2010RecipientInfos(pub Vec<CryptographicMessageSyntax2010RecipientInfo>);

impl Deref for CryptographicMessageSyntax2010RecipientInfos {
    type Target = Vec<CryptographicMessageSyntax2010RecipientInfo>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CryptographicMessageSyntax2010RecipientInfos {
...
impl DERSerializable for CryptographicMessageSyntax2010RecipientInfos {
