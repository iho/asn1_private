...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETWeightCode {
    NotApplicable = 0,
    UltraLight = 1,
    ExtraLight = 2,
    Light = 3,
...
impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETWeightCode {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::NotApplicable),
            1 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::UltraLight),
            2 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::ExtraLight),
            3 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::Light),
            4 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::SemiLight),
            5 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::Medium),
            6 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::SemiBold),
            7 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::Bold),
            8 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::ExtraBold),
            9 => Ok(ISOSTANDARD9541FONTATTRIBUTESETWeightCode::UltraBold),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETWeightCode: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETWeightCode {
