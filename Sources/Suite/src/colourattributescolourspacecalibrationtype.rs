...
#[derive(Clone, Debug)]
pub enum ColourAttributesColourSpaceCalibrationType {
    NoCalibration = 0,
    Matrices = 1,
    LookupTables = 2,
    MatricesAndLookupTables = 3,
}

impl DERParseable for ColourAttributesColourSpaceCalibrationType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ColourAttributesColourSpaceCalibrationType::NoCalibration),
            1 => Ok(ColourAttributesColourSpaceCalibrationType::Matrices),
            2 => Ok(ColourAttributesColourSpaceCalibrationType::LookupTables),
            3 => Ok(ColourAttributesColourSpaceCalibrationType::MatricesAndLookupTables),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ColourAttributesColourSpaceCalibrationType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ColourAttributesColourSpaceCalibrationType {
