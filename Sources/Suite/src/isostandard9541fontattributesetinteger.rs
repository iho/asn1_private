...
#[derive(Clone, Debug)]
pub enum ISOSTANDARD9541FONTATTRIBUTESETInteger {
    First = -2147483648,
    Last = 2147483647,
}

impl DERParseable for ISOSTANDARD9541FONTATTRIBUTESETInteger {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            -2147483648 => Ok(ISOSTANDARD9541FONTATTRIBUTESETInteger::First),
            2147483647 => Ok(ISOSTANDARD9541FONTATTRIBUTESETInteger::Last),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ISOSTANDARD9541FONTATTRIBUTESETInteger: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ISOSTANDARD9541FONTATTRIBUTESETInteger {
