...
#[derive(Debug, Clone)]
pub struct ANSIX962ECCAlgorithms(pub Vec<ANSIX962ECCAlgorithm>);

impl Deref for ANSIX962ECCAlgorithms {
    type Target = Vec<ANSIX962ECCAlgorithm>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for ANSIX962ECCAlgorithms {
...
impl DERSerializable for ANSIX962ECCAlgorithms {
