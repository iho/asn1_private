...
#[derive(Clone, Debug)]
pub struct AlgorithmInformation2009KEYWRAP {
    pub algorithm: ASN1ObjectIdentifier,
    pub parameters: Option<ASN1Node>,
}

impl DERParseable for AlgorithmInformation2009KEYWRAP {
...
impl DERSerializable for AlgorithmInformation2009KEYWRAP {
