...
#[derive(Clone, Debug)]
pub enum CharacterPresentationAttributesPairwiseKerning {
    No = 0,
    Yes = 1,
}

impl DERParseable for CharacterPresentationAttributesPairwiseKerning {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(CharacterPresentationAttributesPairwiseKerning::No),
            1 => Ok(CharacterPresentationAttributesPairwiseKerning::Yes),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for CharacterPresentationAttributesPairwiseKerning: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for CharacterPresentationAttributesPairwiseKerning {
