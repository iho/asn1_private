...
#[derive(Clone, Debug)]
pub enum ColourAttributesColourModesPresent {
    Direct = 0,
    Indexed = 1,
    Both = 2,
}

impl DERParseable for ColourAttributesColourModesPresent {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(ColourAttributesColourModesPresent::Direct),
            1 => Ok(ColourAttributesColourModesPresent::Indexed),
            2 => Ok(ColourAttributesColourModesPresent::Both),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for ColourAttributesColourModesPresent: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for ColourAttributesColourModesPresent {
