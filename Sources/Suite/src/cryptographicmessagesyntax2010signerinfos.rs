...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2010SignerInfos(pub Vec<CryptographicMessageSyntax2010SignerInfo>);

impl Deref for CryptographicMessageSyntax2010SignerInfos {
    type Target = Vec<CryptographicMessageSyntax2010SignerInfo>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}

impl DERParseable for CryptographicMessageSyntax2010SignerInfos {
...
impl DERSerializable for CryptographicMessageSyntax2010SignerInfos {
