...
#[derive(Debug, Clone)]
pub struct CryptographicMessageSyntax2009Attributes(pub Vec<crate::PKIXCommonTypes2009Attribute>);

impl Deref for CryptographicMessageSyntax2009Attributes {
...
impl DERParseable for CryptographicMessageSyntax2009Attributes {
...
impl DERSerializable for CryptographicMessageSyntax2009Attributes {
