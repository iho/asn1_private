...
#[derive(Clone, Debug)]
pub enum LayoutDescriptorsLayoutObjectType {
...
impl DERParseable for LayoutDescriptorsLayoutObjectType {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LayoutDescriptorsLayoutObjectType::DocumentLayoutRoot),
            1 => Ok(LayoutDescriptorsLayoutObjectType::PageSet),
            2 => Ok(LayoutDescriptorsLayoutObjectType::Page),
            3 => Ok(LayoutDescriptorsLayoutObjectType::Frame),
            4 => Ok(LayoutDescriptorsLayoutObjectType::Block),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LayoutDescriptorsLayoutObjectType: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LayoutDescriptorsLayoutObjectType {
