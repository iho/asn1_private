...
#[derive(Clone, Debug)]
pub enum LayoutDescriptorsTransparency {
    Transparent = 0,
    Opaque = 1,
}

impl DERParseable for LayoutDescriptorsTransparency {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        ...
        match val {
            0 => Ok(LayoutDescriptorsTransparency::Transparent),
            1 => Ok(LayoutDescriptorsTransparency::Opaque),
            _ => Err(ASN1Error::new(rust_asn1::errors::ErrorCode::InvalidASN1Object, format!("Unknown value for LayoutDescriptorsTransparency: {}", val), file!().to_string(), line!()))
        }
    }
}

impl DERSerializable for LayoutDescriptorsTransparency {
