...
#[derive(Clone, Debug)]
pub enum PKIXAlgs2009ECParameters {
    NamedCurve(ASN1ObjectIdentifier),
}

impl DERParseable for PKIXAlgs2009ECParameters {
    fn from_der_node(node: ASN1Node) -> Result<Self, ASN1Error> {
        match (node.identifier.tag_number, node.identifier.tag_class) {
            (220, TagClass::ContextSpecific) => Ok(Self::NamedCurve(ASN1ObjectIdentifier::from_der_node(node)?)),
            _ => Err(ASN1Error::new(
...
impl DERSerializable for PKIXAlgs2009ECParameters {
